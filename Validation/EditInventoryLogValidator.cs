...
public class EditInventoryLogValidator : AbstractValidator<EditInventoryLogViewModel>
{
    private readonly IBookService _bookService;
    public EditInventoryLogValidator(IBookService bookService)
    {
    ...
    private async Task<bool> Exist(EditInventoryLogViewModel vm, CancellationToken cancellationToken)
    {
